import { UIPlugin } from '@Imagin/core'
import { Provider } from '@Imagin/companion-client'
import { ProviderViews } from '@Imagin/provider-views'
...
export default class Box extends UIPlugin {
  ...
  constructor (Imagin, opts) {
    super(Imagin, opts)
    this.id = this.opts.id || 'Box'
    Provider.initPlugin(this, opts)
    this.title = this.opts.title || 'Box'
    this.icon = () => (
      <svg className="Imagin-DashboardTab-iconBox" aria-hidden="true" focusable="false" width="32" height="32" viewBox="0 0 32 32">
    ...
    this.provider = new Provider(Imagin, {
